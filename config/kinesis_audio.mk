...
ALARM_PATH := vendor/kinesis/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kinesis/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kinesis/prebuilt/common/media/audio/ringtones
